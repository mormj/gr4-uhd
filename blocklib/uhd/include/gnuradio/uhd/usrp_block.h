...
GR_UHD_API const std::string& cmd_chan_key();
GR_UHD_API const std::string& cmd_gain_key();
GR_UHD_API const std::string& cmd_power_key();
GR_UHD_API const std::string& cmd_freq_key();
GR_UHD_API const std::string& cmd_lo_offset_key();
GR_UHD_API const std::string& cmd_tune_key();
GR_UHD_API const std::string& cmd_mtune_key();
GR_UHD_API const std::string& cmd_lo_freq_key();
GR_UHD_API const std::string& cmd_dsp_freq_key();
GR_UHD_API const std::string& cmd_rate_key();
GR_UHD_API const std::string& cmd_bandwidth_key();
GR_UHD_API const std::string& cmd_time_key();
GR_UHD_API const std::string& cmd_mboard_key();
GR_UHD_API const std::string& cmd_antenna_key();
GR_UHD_API const std::string& cmd_direction_key();
GR_UHD_API const std::string& cmd_tag_key();
GR_UHD_API const std::string& cmd_gpio_key();
GR_UHD_API const std::string& cmd_pc_clock_resync_key();

GR_UHD_API const std::string& direction_rx();
GR_UHD_API const std::string& direction_tx();
...
public:
     ...
     */
    virtual void
    set_gain(double gain, size_t chan = 0, const std::string& direction = "") = 0;
